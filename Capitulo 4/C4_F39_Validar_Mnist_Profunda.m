...
%%
%
%Validación de la red ya entrenada
...
% Cálculo de la salida de la red con la entrada de prueba
...
% Cálculo del porcentaje de errores
Porcentaje_Errores=sum(Cantidad_Errores)/length(Cantidad_Errores)
% Cálculo del porcentaje de aciertos o precisión 
