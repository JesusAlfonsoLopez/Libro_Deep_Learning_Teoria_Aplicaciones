...
% manoescritos del data set MNIST
%
% Autor:
%       jalopez@uao.edu.co
...
% Se crean dos capas convolucionales adicionales de filtros del mismo
% tamaño 3x3 pero una con 32 filtros y la otra con 64 filtros
